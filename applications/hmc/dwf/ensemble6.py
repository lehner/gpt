...
action_gauge = g.qcd.gauge.action.iwasaki(2.1233)

# better init study mc dependence
# v0: beta=2.135 until ensemble-6a/ckpoint_lat.122
# v1: beta=2.13 until ensemble-6a/ckpoint_lat.304
# v2: beta=2.1233
...
hasenbusch_ratios = [  # Nf=2+1
    ...
    (0.5, 1.0, rat_fnc, eofa_ratio_smeared, slv_e, slv_s, charm),
]
