...
action_gauge = g.qcd.gauge.action.iwasaki(2.1175)

# better init study mc dependence
# v0: beta=2.135 until ensemble-7a/ckpoint_lat.119
# v1: beta=2.115 until ensemble-7a/ckpoint_lat.299
# v2: beta=2.1175
...
hasenbusch_ratios = [  # Nf=2+1
    ...
    (0.35, 1.0, rat_fnc, eofa_ratio_smeared, slv_e, slv_s, charm),
]
