...
action_gauge = g.qcd.gauge.action.iwasaki(2.2418)

# better init study mc dependence
# v0: beta=2.255 until ensemble-8a/ckpoint_lat.123
# v1: beta=2.245 until ensemble-8a/ckpoint_lat.326
# v2: beta=2.2418

# starting 916 we changed the integrator and 7->9 poles
...
hasenbusch_ratios = [  # Nf=2+1
    ...
    (0.4539, 1.0, rat_fnc, eofa_ratio_smeared, mk_slv_e(), mk_slv_s(), charm),
]
