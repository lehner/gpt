...
rat = g.algorithms.rational.zolotarev_inverse_square_root(1.0**0.5, 11**0.5, 9) # previously 7 and error of action 1.92e-9
...
hasenbusch_ratios = [ # Nf=2+1
    ...
    (0.0049, 0.017, None, two_flavor_ratio, mk_chron(cg_e), mk_chron(cg_s)),
...
action_fermions_e = [af(
    lambda m_plus, m_minus: quark(U, m_plus, m_minus),
    m1, m2,
    se
...
# may be better
# mdint = sympl.OMF2(15, ip_fermion, sympl.OMF2(8, ip_gauge, iq))

# the following was slightly faster but also slightly less accurate
# mdint = sympl.OMF4(7, ip_fermion, sympl.OMF4(2, ip_gauge, iq))
