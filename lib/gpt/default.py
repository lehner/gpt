...
# verbosity
verbose_default = "io,bicgstab,cg,dci,fgcr,fgmres,mr,irl,repository,arnoldi,power_iteration,checkpointer,deflate,block_operator,random,split,mg_setup,mg_prec,coarsen,orthogonalize"
